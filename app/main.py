...
@app.route('/news_0392', methods=['GET'])
def get_news():
...
@app.route('/news_0392/<news_id>', methods=['GET'])
...
@app.route('/news_0392', methods=['POST'])
def insert_news():
...
@app.route('/news_0392/<news_id>', methods=['PUT'])
...
@app.route('/news_0392/<news_id>', methods=['PATCH'])
...
@app.route('/news_0392/<news_id>', methods=['DELETE'])
